...
<script>
    activeClassesUrl = "{{url('/dean/dashboard/get-active-classes')}}";
    activeEventsUrl = "{{url('/dean/dashboard/get-calendar-events')}}";
    activeQuoteUrl = "{{url('/dean/dashboard/get-daily-quote')}}";
    apptQueueUrl = "{{url('/dean/appointments/latest-appt-json')}}";
    academicCalendarLink = "{{url('/dean/functions/program-course-management/academic_calendar')}}";
    sectionsLink = "{{url('/dean/functions/program-course-management/sections')}}";
    window.programData = @json($programData);
    window.trendData = @json($trendData);
</script>
<script src="{{asset('js/dean_dashboard.js')}}" ></script>
